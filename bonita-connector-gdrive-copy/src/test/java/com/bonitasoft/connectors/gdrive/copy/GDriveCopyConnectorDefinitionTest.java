 ...
 */
@DisplayName("GDrive Copy Connector Definition Tests")
class GDriveCopyConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-copy.def";
        InputStream defIs = GDriveCopyConnectorDefinitionTest.class.getClassLoader()
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-copy.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.copy.GDriveCopyConnector";
        try {
