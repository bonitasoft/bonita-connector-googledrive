 ...
 */
@DisplayName("GDrive Move Connector Definition Tests")
class GDriveMoveConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-move.def";
        InputStream defIs = GDriveMoveConnectorDefinitionTest.class.getClassLoader()
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-move.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.move.GDriveMoveConnector";
        try {
