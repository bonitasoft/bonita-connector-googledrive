 ...
 */
@DisplayName("GDrive Delete Connector Definition Tests")
class GDriveDeleteConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-delete.def";
        InputStream defIs = GDriveDeleteConnectorDefinitionTest.class.getClassLoader()
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-delete.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.delete.GDriveDeleteConnector";
        try {
