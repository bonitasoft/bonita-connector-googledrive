 ...
 */
@DisplayName("GDrive Search Connector Definition Tests")
class GDriveSearchConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-search.def";
        InputStream defIs = GDriveSearchConnectorDefinitionTest.class.getClassLoader()
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-search.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.search.GDriveSearchConnector";
        try {
