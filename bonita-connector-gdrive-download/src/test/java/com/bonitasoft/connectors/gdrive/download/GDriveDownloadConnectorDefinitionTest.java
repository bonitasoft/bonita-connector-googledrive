 ...
 */
@DisplayName("GDrive Download Connector Definition Tests")
class GDriveDownloadConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-download.def";
        InputStream defIs = GDriveDownloadConnectorDefinitionTest.class.getClassLoader()
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-download.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.download.GDriveDownloadConnector";
        try {
