 ...
 */
@DisplayName("GDrive CreateFolder Connector Definition Tests")
class GDriveCreateFolderConnectorDefinitionTest {
    ...
    static void loadDefinition() throws Exception {
        ...
        String defPath = "gdrive-create-folder.def";
        InputStream defIs = GDriveCreateFolderConnectorDefinitionTest.class.getClassLoader()
    ...
    void shouldHaveValidConnectorId() {
        ...
        assertThat(connectorId)
                ...
                .isEqualTo("gdrive-create-folder");
    }
    ...
    void widgetsShouldHaveLabels() {
        ...
        InputStream propsIs = getClass().getClassLoader()
                .getResourceAsStream("gdrive-create-folder.properties");
    ...
    void connectorClassShouldExist() {
        String expectedClass = "com.bonitasoft.connectors.gdrive.createfolder.GDriveCreateFolderConnector";
        try {
